  ...
  return (
    <>
      ...
      <div className="container">
        <h2 className="text-center a">ONCE UPON <b>AN AFFAIRE</b></h2>
        <br />
        <div className="row">
      ...
      <div className="container-fluid ca">
        <div className="row">
          ...
          <div className="col-md-8 text-center text-white bannerTxt" >
            <h1 className="d">THE GAME CHANGER</h1>
            <p className="e">The company is dedicated to being a game changer in the F&B industry with the introduction of ‘concept’ restaurants. It is committed to catering to the ever-changing cosmopolitan taste of its customers & customer satisfaction is an utmost priority.</p>
      ...
      <div className="container">
        <h2 className="text-center a">JOIN <b>OUR FAMILY</b></h2>
        <br />
        <div className="row">
          <div className="col-md-7">
            ...
            <button className="btn btn-warning">Franchases with us</button>


          </div>
          <div className="col-md-5 text-center">
            <img src="https://pn-paul.netlify.app/image/333X3322.jpg" alt="" className="img123" />
